use crate::{
    ...
    Get, GetMut, GetOwned, Insert, InsertMut, LoadedEvent, LogToken, LogVars, Obj, ObjBase,
...
where
    E: CtxTypeInfo + EntityObj<Tbl = VecTable<E>> + EntityValidate,
    E::Key: Copy + Eq + Hash,
    VecTable<E>: ObjBase<Log = Log<E>>,
    TransactionProvider<'a>: Upsert<E>,
    usize: From<E::Key>,
